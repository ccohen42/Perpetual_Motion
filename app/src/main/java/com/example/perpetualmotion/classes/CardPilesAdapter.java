...
public class CardPilesAdapter extends RecyclerView.Adapter<CardPileTopViewHolder>
{
    ...
    @NonNull @Override public CardPileTopViewHolder onCreateViewHolder (@NonNull ViewGroup parent, int viewType)
    {
    ...
    @Override public void onBindViewHolder (@NonNull CardPileTopViewHolder holder, int position)
    {
